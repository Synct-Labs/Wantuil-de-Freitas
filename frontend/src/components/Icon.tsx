// Biblioteca de ícones SVG profissionais — substituem todos os emojis.
// Baseados na Lucide / Feather (open source, ISC).
import { CSSProperties } from 'react';

interface Props { name: IconName; size?: number; color?: string; style?: CSSProperties }

export type IconName =
  | 'home' | 'package' | 'arrow-down' | 'arrow-up' | 'clock' | 'building'
  | 'heart' | 'users' | 'chart-bar' | 'settings' | 'log-out' | 'menu'
  | 'plus' | 'pencil' | 'trash' | 'check' | 'x' | 'alert-triangle'
  | 'alert-circle' | 'bell' | 'search' | 'tag' | 'printer' | 'download'
